...
class TestWebRouteBinaryGuard:
    def test_screenshot_upload_at_setup_does_not_poison_profile(self, gated_app):
        ...
        assert "unsupported_binary" in status or status.startswith("unsupported"), (
