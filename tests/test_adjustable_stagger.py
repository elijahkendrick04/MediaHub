...
def test_staggerscale_folds_into_story_cache_key_only_when_present():
    ...
    # revision is — bumped past "5" by later per-glyph-text + range-selector +
    # varfont-animation changes, all unrelated to staggerScale's
    # fold-only-when-present behaviour proved above.)
