...
def _page(tmp_path, monkeypatch, path):
...
def test_plan_handlers_drive_the_loader(tmp_path, monkeypatch):
    html = _page(tmp_path, monkeypatch, "/plan")
...
def test_analytics_digest_drives_the_loader(tmp_path, monkeypatch):
    html = _page(tmp_path, monkeypatch, "/plan/analytics")
