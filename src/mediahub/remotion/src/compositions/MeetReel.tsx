...
export const meetReelSchema = z.object({
  ...
  // Optional: absent = the default skeleton (the component fills 2.0/1.0 and
  // the top-card emphasis), so a reel rendered without a rhythm prop is
  // byte-identical to before R1.12. Present = caller customisation, with each
  // inner field defaulted by the schema above.
...
export const MeetReel: React.FC<Props> = ({ cards, brand, meetName, rhythm }) => {
