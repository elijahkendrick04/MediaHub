...
FORMATS: dict[str, ExportFormat] = {
    ...
    "png": _f(
        ...
        transparency=True, accepts=("scale", "transparent"),
    ),
    "jpg": _f(
        "jpg", "JPEG", "image", ".jpg", "image/jpeg",
        lossy=True, accepts=("quality", "scale"),
    ),
    "webp": _f(
        "webp", "WebP", "image", ".webp", "image/webp",
        lossy=True, transparency=True, accepts=("quality", "scale", "transparent"),
    ),
    "avif": _f(
    ...
    "svg": _f(
        "svg", "SVG (vector)", "image", ".svg", "image/svg+xml",
        transparency=True, accepts=("transparent",),
    ),
    # --- video -------------------------------------------------------------
    "mp4": _f("mp4", "MP4 (H.264)", "video", ".mp4", "video/mp4", lossy=True, accepts=("scale",)),
    "webm": _f(
        "webm", "WebM (VP9)", "video", ".webm", "video/webm",
        lossy=True, transparency=True, accepts=("quality", "scale", "transparent"),
    ),
    ...
    "ogg": _f("ogg", "OGG (Vorbis)", "audio", ".ogg", "audio/ogg", lossy=True, accepts=("quality",)),
    ...
    "print_pdf": _f(
        "print_pdf", "Print PDF (bleed + marks)", "document", ".pdf", "application/pdf",
        accepts=("colour_profile",),
    ),
    "pptx": _f(
        "pptx", "PowerPoint (PPTX)", "document", ".pptx",
        "application/vnd.openxmlformats-officedocument.presentationml.presentation",
    ),
    "docx": _f(
        "docx", "Word (DOCX)", "document", ".docx",
