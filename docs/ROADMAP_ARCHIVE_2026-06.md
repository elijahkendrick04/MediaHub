# Roadmap archive — June 2026 (frozen)

> **This is the archived long-form roadmap**, frozen at `7f5297b18`
> (2026-06-10) when [`ROADMAP.md`](ROADMAP.md) was restructured into a lean
> to-do / completed format. Everything here — the phase essays, the
> commercial analysis and revenue tables, the strategy notes, and
> **Appendices A/B/C** (the PAR-\*/SEQ-\*/Step-N build & verification
> prompts) — is preserved verbatim for reference. Statuses below are AS OF
> the freeze and are **not** updated; the live lists are in
> [`ROADMAP.md`](ROADMAP.md). The auto-update marker blocks have been
> disarmed (`ARCHIVED-ROADMAP:`) so no tooling ever edits this file.
