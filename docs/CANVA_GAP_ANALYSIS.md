...
| B5 | Die-cut sticker outline around cutouts (also masks rembg fringe). | `sticker` photo treatment: 8-direction stacked drop-shadow contour in a role ink — same maths expressible in the motion grade for parity. | **[SHIPPED]** |
