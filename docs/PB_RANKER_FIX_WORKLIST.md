...
| **F33** | 🟡 | `legacy/swim_content/ranker_v3.py`:177 | The anti-spam spotlight-demotion rule is dead in the live pipeline (grouper emits spotlight XOR standouts). Either wire it to a reachable state or remove it and its docstring. |
