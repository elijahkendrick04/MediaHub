...
| `api_forms_create` | `POST` | `/api/forms` |
| `api_form_delete` | `POST` | `/api/forms/<form_id>/delete` |
| `api_form_save` | `POST` | `/api/forms/<form_id>/save` |
...
| `api_site_delete` | `POST` | `/api/sites/<site_id>/delete` |
| `api_site_insights` | `GET` | `/api/sites/<site_id>/insights` |
| `api_site_password` | `POST` | `/api/sites/<site_id>/password` |
| `api_site_publish` | `POST` | `/api/sites/<site_id>/publish` |
| `api_site_save` | `POST` | `/api/sites/<site_id>/save` |
| `api_site_unpublish` | `POST` | `/api/sites/<site_id>/unpublish` |
| `api_sites_generate` | `POST` | `/api/sites/generate` |
...
| `site_public_home` | `GET` | `/site/<token>` |
| `site_public_page` | `GET` | `/site/<token>/<slug>` |
| `site_card_png` | `GET` | `/site/<token>/card/<run_id>/<card_id>.png` |
| `site_form_submit` | `POST` | `/site/<token>/form/<form_id>` |
| `site_robots` | `GET` | `/site/<token>/robots.txt` |
| `site_sitemap` | `GET` | `/site/<token>/sitemap.xml` |
| `site_unlock` | `POST` | `/site/<token>/unlock` |
| `site_widget_vote` | `POST` | `/site/<token>/widget/<widget_id>/vote` |
| `sites_home` | `GET` | `/sites` |
| `site_editor` | `GET` | `/sites/<site_id>` |
| `site_preview_card_png` | `GET` | `/sites/<site_id>/card/<run_id>/<card_id>.png` |
| `site_preview_home` | `GET` | `/sites/<site_id>/preview` |
| `site_preview_page` | `GET` | `/sites/<site_id>/preview/<slug>` |
| `api_site_qr` | `GET` | `/sites/<site_id>/qr.<fmt>` |
